...
FileDescriptorSet = _reflection.GeneratedProtocolMessageType('FileDescriptorSet', (_message.Message,), dict(
  ...
  __module__ = 'gnmi.descriptor_pb2'
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\023com.google.protobufB\020DescriptorProtosH\001Z>github.com/golang/protobuf/protoc-gen-go/descriptor;descriptor\242\002\003GPB\252\002\032Google.Protobuf.Reflection'))
_FILEOPTIONS.fields_by_name['java_generate_equals_and_hash'].has_options = True
_FILEOPTIONS.fields_by_name['java_generate_equals_and_hash']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_SOURCECODEINFO_LOCATION.fields_by_name['path'].has_options = True
_SOURCECODEINFO_LOCATION.fields_by_name['path']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_SOURCECODEINFO_LOCATION.fields_by_name['span'].has_options = True
_SOURCECODEINFO_LOCATION.fields_by_name['span']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_GENERATEDCODEINFO_ANNOTATION.fields_by_name['path'].has_options = True
_GENERATEDCODEINFO_ANNOTATION.fields_by_name['path']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
